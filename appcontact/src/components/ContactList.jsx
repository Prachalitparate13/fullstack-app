  ...
  return (
   <main className='main'>
        ...
        <div className='pagination'>
            <a className={0=== currentPage? 'disabled':''} onClick={()=>getAllContacts(currentPage-1)}>&laquo;</a>
            {data &&
            ...
            <a className={data.totalPages === currentPage + 1 ? 'disabled':''} onClick={()=>getAllContacts(currentPage + 1)}> &raquo;</a>  
        </div>}
   </main>
  )
}
